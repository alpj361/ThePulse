...
import { MoreVertical, Eye, Edit, Trash2, MapPin, Globe } from 'lucide-react';
...
const LocationCard: React.FC<LocationCardProps> = ({ item, onView, onEdit, onDelete }) => {
  const country = item.metadata?.country || item.metadata?.pais;
  ...
  return (
    <Card className="relative bg-white shadow-md hover:shadow-lg transition-all duration-300 rounded-lg overflow-hidden flex flex-col">
      <CardHeader className="p-4 border-b border-slate-200 bg-gradient-to-r from-red-50 to-red-100">
        <div className="flex items-start justify-between gap-2">
          <div className="flex items-start gap-3 flex-1 min-w-0">
            <div className="p-2.5 rounded-xl bg-red-600 flex-shrink-0 mt-1">
