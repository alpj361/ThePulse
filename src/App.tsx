...
export const VerifiedRoute = ({ children }: { children: React.ReactNode }) => {
  ...
  const isProtectedPath = ['/dashboard', '/recent', '/sources', '/analytics', '/settings', '/admin', '/library', '/codex', '/news', '/canvas'].includes(currentPath);
      ...
      <SpreadsheetProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            {/* Legacy redirect */}
            <Route path="/tableros" element={<Navigate to="/canvas" replace />} />
            <Route path="/canvas/compact" element={
              <VerifiedRoute>
                <Layout>
                  <Sondeos />
                </Layout>
            ...
            <Route path="/canvas/modern" element={
              <VerifiedRoute>
                <Layout>
                  <SondeosModern />
                </Layout>
